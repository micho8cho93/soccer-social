...
urlpatterns = [
    ...
    path('tournament/<int:tournament_id>/<int:season_id>/group/<int:group_id>/', views.tournament_group_detail, name='tournament_group_detail'),
    path('tournament/<int:tournament_id>/<int:season_id>/matchdays/<int:year>/<int:month>/<int:day>/', views.tournament_matchday_detail_by_date, name='tournament_matchday_detail_by_date'),
