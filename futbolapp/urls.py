...
urlpatterns = [
    ...
    path('tournament_match/<int:match_id>/stats/', views.tournament_match_statistics, name='tournament_match_statistics'),
    path('tournament_match/<int:match_id>/roster/', views.tournament_match_roster_view, name='tournament_match_roster_view'),
    path('tournament_match/<int:match_id>/roster/update/', views.update_tournament_roster_view, name='update_tournament_roster_view'),
